...
function TravellerRegister(){
  ...
  const [Traveller, setTraveller] = useState({
      ...
      "name": "string",
      "dateOfBirth": "2023-08-06T19:55:52.807Z",
      "gender": "string",
      "phone": "string",
      "email": "string",
      "address": "string",
  ...
  const TravellerRegister = (event) => {
    event.preventDefault(); // Prevent form submission

    console.log(Traveller);
    fetch("http://localhost:5013/api/User/RegisterTraveller", {
      method: "POST",
      headers: {
          ...
          <div className="col-12 col-lg-9 col-xl-7">
            <div className="card shadow-2-strong card-registration">
              <div className="card-body p-4 p-md-5">
                <h3 className="mb-4 pb-2 pb-md-0 mb-md-5">Traveller Registration Form</h3>
                <form onSubmit={TravellerRegister}>
                  <div className="row">
