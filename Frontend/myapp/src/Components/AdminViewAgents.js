...
import IndividualAgents from "./IndividualAgents";
...
function AdminViewAgents(){
    ...
    const getAgents = () => {
        fetch("http://localhost:5013/api/User/GetAllAgents", {
      method: 'GET',
      headers: {
        accept: 'text/plain',
      ...
      <nav className="navbar home-navbar navbar-expand-lg navbar-light bg-white" id="home-navbar">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#add-doctors">MANAGE AGENTS</a>
                        </li>
                        <li className="nav-item">
             ...
             <div classname="vh-100">
              <br/>
              <b className="text-center">All Agents</b>
              <br/>

              <div className="GetAll vh-100" >
                {
                    agents.map((agent,index)=>{
                    return(<IndividualAgents key={index} user = {agent}/>)
                })
                }
            </div>
            </div>
